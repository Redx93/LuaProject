...
//		{
//			Tower* sprite1 = (Tower*)lua_touserdata(L, -1);
//			sm->RemoveSprite(sprite1);
//			sprite1->~Tower();
//		}
//		else
//		{
...
//		if (type == "Tower")
//		{
//			Tower* sprite = (Tower*)lua_touserdata(L, -1);
//			std::string typeOf = sprite->GetTowerType();
//		}
